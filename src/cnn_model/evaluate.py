...
def evaluate_model(model_path="models/cnn/cnn_model.pth", batch_size=32, data_path="Data_Set"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="models/cnn/cnn_model.pth", help="Path to saved model")
