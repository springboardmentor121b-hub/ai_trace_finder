...
def get_dataloaders(data_root="D:\Project\TraceFinder\data", batch_size=32, img_size=128, val_split=0.1, test_split=0.1):
    """
    ...
    # 1. Official Dataset
    official_dir = os.path.join(data_root, "D:\Project\TraceFinder\data\Official")
    ...
    # 2. Wikipedia Dataset
    wiki_dir = os.path.join(data_root, "D:\Project\TraceFinder\data\Wikipedia")
