...
CSV_PATH = "../processed_data/Official/metadata_features_wikipedia.csv"
...
if __name__ == "__main__":
    evaluate_model("models_official/random_forest.pkl", "Random Forest")
    evaluate_model("models_official/svm.pkl", "SVM")
