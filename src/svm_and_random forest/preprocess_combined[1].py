...
DATA_ROOT = "D:\Project\TraceFinder\data"
WIKIPEDIA_DIR = os.path.join(DATA_ROOT, "D:\Project\TraceFinder\data\Wikipedia")
OFFICIAL_DIR = os.path.join(DATA_ROOT, "D:\Project\TraceFinder\data\Official")

OUTPUT_DIR = "D:\Project\TraceFinder\processed_data"
