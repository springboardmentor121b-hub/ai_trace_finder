...
if __name__ == "__main__":
    ...
    # OUT_PATH = os.path.join(BASE_DIR, "../../dataSet/results/hybrid_cnn/official_wiki_residuals.pkl")
    OUT_PATH = "../../dataSet/results/hybrid_cnn/official_wiki_residuals.pkl"
    ...
    OUT_PATH_FLAT = "../../dataSet/Flatfield/results/hybrid_cnn/flatfield_residuals.pkl"
