...
# DATASET_OFFICIAL = os.path.normpath(
#     os.path.join(os.path.dirname(__file__), '..', 'dataSet', 'Wikipedia')
# )
DATASET_OFFICIAL = "../dataSet/Official"
# DATASET_WIKIPEDIA = "dataSet/Wikipedia"
