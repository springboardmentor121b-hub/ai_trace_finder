...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="AI TraceFinder - Forensic Scanner Identification",
    page_icon="🔬",
    layout="wide",
...
<div style="text-align: center; margin-bottom: 2.5rem; padding: 1.5rem 0;">
    ...
    <h2 style="
        ...
        letter-spacing: 1px;
    ">AI Tracefinder - Forensic Scanner Identification</h2>
    <p style="
        color: #80deea; 
        font-size: 0.85rem; 
        letter-spacing: 2px; 
...
">
    ...
    <div style="color: #666; line-height: 1.4;">
        © 2024 AI Tracefinder - Forensic Scanner Identification<br>
...
with col_text:
    ...
    st.write(
        """
        **AI Tracefinder - Forensic Scanner Identification** is an advanced forensic analysis system designed to identify the source scanner device 
...
">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; flex-wrap: wrap;">
        <div style="text-align: left;">
            <h4 style="color: #00d4ff; margin-bottom: 5px;">AI Tracefinder - Forensic Scanner Identification</h4>
    ...
    <p style="color: #546e7a; font-size: 0.8rem; margin-top: 1.5rem;">
        © 2026 AI Tracefinder - Forensic Scanner Identification • For Forensic Research and Academic Use Only
    </p>
</div>
""", unsafe_allow_html=True)
